...
The \ttbar\ and single top MC are included in the plots and tables for reference, although it is not used in the measurements. 
...
\caption{Number of events of the main simulated background processes and of
  ...
  statistical. The numbers labeled Data fakes are used the
  measure $\theta$ 
