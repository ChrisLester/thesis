...
Acceptance uncertainties on \ttV\ MC modelling for considered for 5 separate effects: the matrix element to parton shower matching algorithm, the modelling of the jet multiplicity, the modelling of the the parton shower, the QCD scale, and the choice of PDF set. These uncertainties are considered by comparing event yields in the signal regions with different modelling choices for each effect and are summarized in Table \ref{table:background_theory}. 

\begin{table}[tdp]
\caption{Theoretical uncertainties of the \ttW\ and \ttZ\
event yields in the signal regions due to the impact of matching, modelling, parton shower, QCD scalec, and PDF differences on the event selection.}
\begin{center}
\begin{tabular}{|r|c|c|c|c|}
\hline
Matching [\%]         & 2l4jets & 2l$\geq$5jets & 3l & 4l \\
\hline
\ttZ\ & 16.0 & 9.7 & 0.5 & 2.0 \\ 
\ttW\                   & 4.2 & 0.2  & 10.2 & --- \\ 
\hline
...
\begin{tabular}{|r|c|c|c|c|}
\hline
Modeling [\%] & 2l4jets & 2l$\geq$5jets  & 3l & 4l \\
\hline
\ttZ\ & 3.5 & 8.7  & 6.2 & 10.5 \\ 
\ttW\                   & 0.1 & 10.8 & 15.6 & --- \\ 
\hline
...
\begin{tabular}{|r|c|c|c|c|}
\hline
Parton Shower [\%] & 2l4jets & 2l$\geq$5jets & 3l & 4l \\
\hline
\ttZ\ & 2.4 & 10.2 & 2.4 & 2.4 \\ 
\ttW\                  & 2.4 & 10.2 & 13.0 & --- \\ 
\hline
...
\hline
PDF [\%]  & 2l4jets & 2l$\geq$5jets & 3l & 4l\\
\hline
\ttZ\   & 1.5 & 2.3 & 1.4& 0.9\\
\ttW\   & 1.1 & 2.5 & 3.6& ---\\
\hline
