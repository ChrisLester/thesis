...
%% -----------------------------------------------------------------------------
\chapter[\tth Analysis Summary][\tth Analysis Summary]{\tth Analysis Summary}
\label{chapter:analysis} 
This chapter provides an overview of the the set of analyses searching for the Standard Model
...
actual production rate. As such the analysis is optimized to overall sensitivity to the 
...
\tth can be observed in a number of different final states related to the
