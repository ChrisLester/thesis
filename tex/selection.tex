...
\centering
\begin{tabular}{ccc}
\subfloat[2$\ell$ SS]{\includegraphics[angle=90,width=0.32\textwidth]{figs/selection/2l_selection.pdf}} &
\subfloat[3$\ell$]{\includegraphics[angle=90,width=0.32\textwidth]{figs/selection/3l_selection.pdf}} &
\subfloat[4$\ell$]{\includegraphics[angle=90,width=0.32\textwidth]{figs/selection/4l_selection.pdf}} \\
\multicolumn{3}{c}{\includegraphics[angle=90,width=0.69\textwidth]{figs/selection/legend}} \\
\end{tabular} 
